...
pub enum PoolError {
    ...
    /// Wei balance below rent-exempt threshold.
    #[error("Wei balance below rent-exempt threshold")]
    NotRentExempt,
...
impl PrintProgramError for PoolError {
        ...
        E: 'static + std::error::Error + DecodeError<E> + PrintProgramError + FromPrimitive,
    {
        match self {
            ...
            PoolError::NotRentExempt => msg!("Error: Wei balance below rent-exempt threshold"),
