...
pub fn process_instruction(
    ...
    match instruction {
        ...
        RecordInstruction::CloseAccount => {
            ...
            check_authority(authority_info, &account_data.authority)?;
            let destination_starting_weis = destination_info.weis();
            let data_weis = data_info.weis();
            **data_info.weis.borrow_mut() = 0;
            **destination_info.weis.borrow_mut() = destination_starting_weis
                .checked_add(data_weis)
