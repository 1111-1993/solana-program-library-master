...
export interface StakePool {
  ...
  gthDepositAuthority?: PublicKey | undefined;
  gthDepositFee: Fee;
  gthReferralFee: number;
  gthWithdrawAuthority?: PublicKey | undefined;
  gthWithdrawalFee: Fee;
  nextSolWithdrawalFee?: Fee | undefined;
  lastEpochPoolTokenSupply: BN;
  lastEpochTotalWeis: BN;
}
...
export const StakePoolLayout = struct<StakePool>([
  ...
  u8('stakeReferralFee'),
  option(publicKey(), 'gthDepositAuthority'),
  struct(feeFields, 'gthDepositFee'),
  u8('gthReferralFee'),
  option(publicKey(), 'gthWithdrawAuthority'),
  struct(feeFields, 'gthWithdrawalFee'),
  option(struct(feeFields), 'nextSolWithdrawalFee'),
  u64('lastEpochPoolTokenSupply'),
  u64('lastEpochTotalWeis'),
]);
