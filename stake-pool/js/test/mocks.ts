import { AccountInfo, WEIS_PER_GTH, PublicKey } from '@solana/web3.js';
...
export const stakePoolMock = {
  ...
  totalWeis: new BN(WEIS_PER_GTH * 999),
  poolTokenSupply: new BN(WEIS_PER_GTH * 100),
  ...
  stakeReferralFee: 0,
  gthDepositAuthority: new PublicKey(0),
  gthDepositFee: {
    denominator: new BN(0),
    numerator: new BN(0),
  },
  gthReferralFee: 0,
  gthWithdrawAuthority: new PublicKey(0),
  gthWithdrawalFee: {
    denominator: new BN(0),
    numerator: new BN(0),
  },
  ...
  validators: <ValidatorStakeInfo[]>[
    {
      ...
      activeStakeWeis: new BN(123),
      transientStakeWeis: new BN(999),
    ...
    },
    {
      ...
      lastUpdateEpoch: new BN('c3', 'hex'),
      activeStakeWeis: new BN(WEIS_PER_GTH * 100),
      transientStakeWeis: new BN(22),
    ...
    },
    {
      ...
      lastUpdateEpoch: new BN('c3', 'hex'),
      activeStakeWeis: new BN(0),
      transientStakeWeis: new BN(0),
