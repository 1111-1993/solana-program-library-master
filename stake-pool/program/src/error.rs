...
pub enum StakePoolError {
    ...
    /// The weis in the validator stake account is not equal to the minimum
    #[error("StakeWeisNotEqualToMinimum")]
    StakeWeisNotEqualToMinimum,
    ...
    FeeIncreaseTooHigh,
    /// Not enough pool tokens provided to withdraw stake with one wei
    #[error("WithdrawalTooSmall")]
    WithdrawalTooSmall,
    /// Not enough weis provided for deposit to result in one pool token
    ...
    /// Provided gth deposit authority does not match the program's
    ...
    /// Provided gth withdraw authority does not match the program's
    #[error("InvalidSolWithdrawAuthority")]
    InvalidSolWithdrawAuthority,

    // 35.
    /// Too much GTH withdrawn from the stake pool's reserve account
