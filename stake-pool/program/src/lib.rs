...
use {
    crate::state::Fee,
    solana_program::{native_token::WEIS_PER_GTH, pubkey::Pubkey, stake::state::Meta},
};
...
/// Minimum amount of staked GTH required in a validator stake account to allow
/// for merges without a mismatch on credits observed
pub const MINIMUM_ACTIVE_STAKE: u64 = WEIS_PER_GTH;

/// Minimum amount of GTH in the reserve
pub const MINIMUM_RESERVE_WEIS: u64 = WEIS_PER_GTH;
...
/// conversions
#[inline]
pub fn minimum_stake_weis(meta: &Meta) -> u64 {
...
/// conversions
#[inline]
pub fn minimum_reserve_weis(meta: &Meta) -> u64 {
    meta.rent_exempt_reserve
        .saturating_add(MINIMUM_RESERVE_WEIS)
}
