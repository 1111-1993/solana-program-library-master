...
async fn setup() -> (
    ...
    let reserve_weis = 100_000_000_000 + MINIMUM_RESERVE_WEIS;
    stake_pool_accounts
...
async fn success() {
    ...
    let increase_amount = reserve_weis - stake_rent - MINIMUM_RESERVE_WEIS;
    ...
    assert_eq!(
        pre_reserve_stake_account.weis - increase_amount - stake_rent,
