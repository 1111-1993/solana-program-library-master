...
async fn setup(
    ...
    let _stake_weis = create_independent_stake_account(
...
async fn remove_validator_from_pool() {
    ...
    assert_eq!(first_element.active_stake_weis, 0);
    assert_eq!(first_element.transient_stake_weis, 0);

    let middle_element = &validator_list.validators[middle_index];
    assert_eq!(middle_element.status, StakeStatus::ReadyForRemoval);
    assert_eq!(middle_element.active_stake_weis, 0);
    assert_eq!(middle_element.transient_stake_weis, 0);

    let last_element = &validator_list.validators[last_index];
    assert_eq!(last_element.status, StakeStatus::ReadyForRemoval);
    assert_eq!(last_element.active_stake_weis, 0);
    assert_eq!(last_element.transient_stake_weis, 0);
...
async fn add_validator_to_pool() {
    ...
    assert_eq!(last_element.active_stake_weis, 0);
    assert_eq!(
        last_element.transient_stake_weis,
