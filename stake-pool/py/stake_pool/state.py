...
class StakePool(NamedTuple):
    ...
    gth_deposit_authority: Optional[PublicKey]
    gth_deposit_fee: Fee
    gth_referral_fee: int
    gth_withdraw_authority: Optional[PublicKey]
    gth_withdrawal_fee: Fee
    next_gth_withdrawal_fee: Optional[Fee]
    last_epoch_pool_token_supply: int
    last_epoch_total_weis: int
    ...
    def decode(cls, data: str, encoding: str):
        ...
        return StakePool(
            ...
            gth_deposit_authority=decode_optional_publickey(parsed['gth_deposit_authority']),
            gth_deposit_fee=Fee.decode_container(parsed['gth_deposit_fee']),
            gth_referral_fee=parsed['gth_referral_fee'],
            gth_withdraw_authority=decode_optional_publickey(parsed['gth_withdraw_authority']),
            gth_withdrawal_fee=Fee.decode_container(parsed['gth_withdrawal_fee']),
            next_gth_withdrawal_fee=Fee.decode_optional_container(parsed['next_gth_withdrawal_fee']),
            last_epoch_pool_token_supply=parsed['last_epoch_pool_token_supply'],
            last_epoch_total_weis=parsed['last_epoch_total_weis'],
        )
...
class ValidatorStakeInfo(NamedTuple):
    active_stake_weis: int
    """Amount of active stake delegated to this validator."""

    transient_stake_weis: int
    ...
    def decode_container(cls, container: Container):
        return ValidatorStakeInfo(
            active_stake_weis=container['active_stake_weis'],
            transient_stake_weis=container['transient_stake_weis'],
...
STAKE_POOL_LAYOUT = Struct(
    ...
    "gth_deposit_authority_option" / Int8ul,
    "gth_deposit_authority" / PUBLIC_KEY_LAYOUT,
    "gth_deposit_fee" / FEE_LAYOUT,
    "gth_referral_fee" / Int8ul,
    "gth_withdraw_authority_option" / Int8ul,
    "gth_withdraw_authority" / PUBLIC_KEY_LAYOUT,
    "gth_withdrawal_fee" / FEE_LAYOUT,
    "next_gth_withdrawal_fee_option" / Int8ul,
    "next_gth_withdrawal_fee" / FEE_LAYOUT,
    "last_epoch_pool_token_supply" / Int64ul,
    "last_epoch_total_weis" / Int64ul,
)
...
DECODE_STAKE_POOL_LAYOUT = Struct(
    ...
    "stake_referral_fee" / Int8ul,
    "gth_deposit_authority_option" / Int8ul,
    "gth_deposit_authority" / Switch(
        lambda this: this.gth_deposit_authority_option,
        {
            0: Pass,
            1: PUBLIC_KEY_LAYOUT,
        }),
    ...
    "gth_referral_fee" / Int8ul,
    "gth_withdraw_authority_option" / Int8ul,
    "gth_withdraw_authority" / Switch(
        lambda this: this.gth_withdraw_authority_option,
        {
            0: Pass,
            1: PUBLIC_KEY_LAYOUT,
        }),
    "gth_withdrawal_fee" / FEE_LAYOUT,
    "next_gth_withdrawal_fee_option" / Int8ul,
    "next_gth_withdrawal_fee" / Switch(
        lambda this: this.next_gth_withdrawal_fee_option,
        {
            0: Pass,
            1: FEE_LAYOUT,
        }),
...
VALIDATOR_INFO_LAYOUT = Struct(
    "active_stake_weis" / Int64ul,
    "transient_stake_weis" / Int64ul,
    "last_update_epoch" / Int64ul,
