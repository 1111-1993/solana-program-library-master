...
uniform, while also maintaining some GTH in the reserve if desired. Can be run
with the stake pool address, staker keypair, and GTH to leave in the reserve:
