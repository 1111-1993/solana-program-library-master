...
Token account requires 0.00203928 GTH at creation, so the cost for initiating a
feature proposal on a network with 500 validators is approximately 1 GTH.
