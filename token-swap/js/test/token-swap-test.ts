...
import {newAccountWithWeis} from '../src/util/new-account-with-weis';
...
export async function createTokenSwap(
  ...
  const payer = await newAccountWithWeis(connection, 1000000000);
  owner = await newAccountWithWeis(connection, 1000000000);
  ...
  const swapPayer = await newAccountWithWeis(connection, 10000000000);
