...
use solana_program::{
    ...
    program_memory::{gth_memcmp, gth_memset},
...
impl Processor {
    ...
    pub fn process_close_account(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
        ...
        **source_account_info.weis.borrow_mut() = 0;
        ...
        gth_memset(*source_account_info.data.borrow_mut(), 0, Account::LEN);
    ...
    pub fn cmp_pubkeys(a: &Pubkey, b: &Pubkey) -> bool {
        gth_memcmp(a.as_ref(), b.as_ref(), PUBKEY_BYTES) == 0
    }
...
mod tests {
    ...
    impl solana_sdk::program_stubs::SyscallStubs for SyscallStubs {
        ...
        fn gth_get_clock_sysvar(&self, _var_addr: *mut u8) -> u64 {
