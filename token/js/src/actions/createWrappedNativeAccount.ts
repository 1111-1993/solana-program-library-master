...
/**
 * Create, initialize, and fund a new wrapped native GTH account
 *
 * @param connection     Connection to use
 * @param payer          Payer of the transaction and initialization fees
 * @param owner          Owner of the new token account
 * @param amount         Number of weis to wrap
 ...
 *
 * @return Address of the new wrapped native GTH account
 */
export async function createWrappedNativeAccount(
    ...
    const weis = await getMinimumBalanceForRentExemptAccount(connection);
