...
async fn test_success() {
    ...
    const GTH_DEPOSIT_AMOUNT: u64 = 100;
    const USDC_BORROW_AMOUNT: u64 = 1_000;
    const GTH_DEPOSIT_AMOUNT_WEIS: u64 =
        GTH_DEPOSIT_AMOUNT * WEIS_TO_GTH * INITIAL_COLLATERAL_RATIO;
    ...
    let collateral_price = collateral.market_value.try_div(GTH_DEPOSIT_AMOUNT).unwrap();
    ...
    assert_eq!(gth_reserve.liquidity.market_price, collateral_price,);
