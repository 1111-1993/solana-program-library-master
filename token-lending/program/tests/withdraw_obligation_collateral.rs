...
async fn test_withdraw_fixed_amount() {
    ...
    const GTH_DEPOSIT_AMOUNT_WEIS: u64 = 200 * WEIS_TO_GTH * INITIAL_COLLATERAL_RATIO;
    ...
    const WITHDRAW_AMOUNT: u64 = 100 * WEIS_TO_GTH * INITIAL_COLLATERAL_RATIO;
    ...
    assert_eq!(
        ...
        GTH_DEPOSIT_AMOUNT_WEIS - WITHDRAW_AMOUNT
    );
}
...
async fn test_withdraw_too_large() {
    ...
    const USDC_BORROW_AMOUNT_FRACTIONAL: u64 = 1_000 * FRACTIONAL_TO_USDC;
    const GTH_RESERVE_COLLATERAL_WEIS: u64 = 2 * GTH_DEPOSIT_AMOUNT_WEIS;
    const WITHDRAW_AMOUNT: u64 = (100 * WEIS_TO_GTH * INITIAL_COLLATERAL_RATIO) + 1;
