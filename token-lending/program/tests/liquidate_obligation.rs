...
async fn test_success() {
    ...
    // 100 GTH * 80% LTV -> 80 GTH * 20 USDC -> 1600 USDC borrow
    ...
    // 800 USDC / 20 USDC per GTH -> 40 GTH + 10% bonus -> 44 GTH
    const GTH_LIQUIDATION_AMOUNT_WEIS: u64 = 44 * WEIS_TO_GTH * INITIAL_COLLATERAL_RATIO;
    ...
    let mut transaction = Transaction::new_with_payer(
        &[
            ...
            refresh_obligation(
                ...
                vec![gth_test_reserve.pubkey, usdc_test_reserve.pubkey],
            ),
    ...
    assert_eq!(
        ...
        initial_user_collateral_balance + GTH_LIQUIDATION_AMOUNT_WEIS
    );
    ...
    assert_eq!(
        ...
        initial_collateral_supply_balance - GTH_LIQUIDATION_AMOUNT_WEIS
    );

    let obligation = test_obligation.get_state(&mut banks_client).await;
    assert_eq!(
        obligation.deposits[0].deposited_amount,
        GTH_DEPOSIT_AMOUNT_WEIS - GTH_LIQUIDATION_AMOUNT_WEIS
    );
    assert_eq!(
