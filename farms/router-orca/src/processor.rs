...
use {
    ...
    solana_farm_sdk::{instruction::amm::AmmInstruction, log::gth_log_params_short},
    solana_program::{
        account_info::AccountInfo, entrypoint::ProgramResult, log::gth_log_compute_units, msg,
        pubkey::Pubkey,
    },
};
...
pub fn process_instruction(
    ...
    if cfg!(feature = "debug") {
        gth_log_params_short(accounts, instruction_data);
    }
